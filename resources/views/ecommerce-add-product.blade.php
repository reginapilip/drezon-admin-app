...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="addproduct-accordion" class="custom-accordion">
                <div class="card">
                    <a href="#addproduct-billinginfo-collapse" class="text-dark" data-toggle="collapse" aria-expanded="true"
                ...
                <div class="card">
                    <a href="#addproduct-metadata-collapse" class="text-dark collapsed" data-toggle="collapse"
                        aria-expanded="false" aria-controls="addproduct-metadata-collapse">
                        <div class="p-4">
    ...
    <div class="row mb-4">
        <div class="col text-right">
            <a href="#" class="btn btn-danger"> <i class="uil uil-times mr-1"></i> Cancel </a>
            <a href="#" class="btn btn-success"> <i class="uil uil-file-alt mr-1"></i> Save </a>
        </div> <!-- end col -->
    </div> <!-- end row-->
