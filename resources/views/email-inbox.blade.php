        ...
        <div class="col-12">
            ...
            <div class="email-leftbar card">
                ...
                <div class="mail-list mt-4">
                    <a href="#" class="active"><i class="mdi mdi-email-outline font-size-16 align-middle mr-2"></i> Inbox
                        <span class="ml-1 float-right">(18)</span></a>
                    <a href="#"><i class="mdi mdi-star-outline font-size-16 align-middle mr-2"></i>Starred</a>
                    <a href="#"><i class="mdi mdi-diamond-stone font-size-16 align-middle mr-2"></i>Important</a>
                    <a href="#"><i class="mdi mdi-file-outline font-size-16 align-middle mr-2"></i>Draft</a>
                    <a href="#"><i class="mdi mdi-email-check-outline font-size-16 align-middle mr-2"></i>Sent Mail</a>
                    <a href="#"><i class="mdi mdi-trash-can-outline font-size-16 align-middle mr-2"></i>Trash</a>
                </div>

                <h6 class="mt-4">Labels</h6>

                <div class="mail-list mt-1">
                    <a href="#"><span class="mdi mdi-radiobox-marked text-info mr-2"></span>Theme Support</a>
                    <a href="#"><span class="mdi mdi-radiobox-marked text-warning mr-2"></span>Freelance</a>
                    <a href="#"><span class="mdi mdi-radiobox-marked text-primary mr-2"></span>Social</a>
                    <a href="#"><span class="mdi mdi-radiobox-marked text-danger mr-2"></span>Friends</a>
                    <a href="#"><span class="mdi mdi-radiobox-marked text-success mr-2"></span>Family</a>
                </div>
                ...
                <div class="mt-2">
                    <a href="#" class="media">
                        <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-2.jpg') }}"
                    ...
                    <a href="#" class="media">
                        <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-3.jpg') }}"
                            alt="Generic placeholder image" height="36">
                        <div class="media-body chat-user-box overflow-hidden">
                    ...
                    <a href="#" class="media">
                        <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-4.jpg') }}"
                            alt="Generic placeholder image" height="36">
                        <div class="media-body chat-user-box overflow-hidden">
                    ...
                    <a href="#" class="media">
                        <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-6.jpg') }}"
                            alt="Generic placeholder image" height="36">
                        <div class="media-body chat-user-box overflow-hidden">
                    ...
                    <a href="#" class="media">
                        <img class="d-flex mr-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-7.jpg') }}"
                            alt="Generic placeholder image" height="36">
                        <div class="media-body chat-user-box overflow-hidden">
                            <p class="user-title m-0">Vicki Brady</p>
                            <p class="text-muted text-truncate">Good Morning!</p>
                        </div>
                    </a>
                </div>
            </div>
