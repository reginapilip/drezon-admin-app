...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Badges Soft</h4>
                    <p class="card-title-desc mb-4">Add <code>.badge</code> & <code>.badge-soft-*</code> for background color.</p>
                    <div class="">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Badges Soft Rounded</h4>
                    <p class="card-title-desc mb-4">Add <code>.badge</code>, <code>.badge-soft-*</code> & <code>.badge-pill</code> for background color.</p>
                    <div class="">
                        ...
                        <span class="badge badge-pill badge-soft-purple">Purple</span>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Badges Outline</h4>
                    <p class="card-title-desc mb-4">Add <code>.badge</code> & <code>.badge-outline-*</code> for border color.</p>
                    <div class="">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Badges Outline Rounded</h4>
                    <p class="card-title-desc mb-4">Add <code>.badge</code>, <code>.badge-outline-*</code> & <code>.badge-pill</code> for border color.</p>
                    <div class="">
                        ...
                        <span class="badge badge-pill badge-outline-purple">Purple</span>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc mb-4">Add <code>.badge</code> & <code>.badge-outline-*</code> for border color.</p>
                    <div class="badges-content button-items">
                        <button type="button" class="btn btn-primary">Primary <span class="badge ml-2">1</span></button>
                        <button type="button" class="btn btn-success">Success <span class="badge ml-2">2</span></button>
                        <button type="button" class="btn btn-info">Info <span class="badge ml-2">3</span></button>
                        <button type="button" class="btn btn-warning">warning <span class="badge ml-2">4</span></button>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc mb-4">Add <code>.badge</code>, <code>.badge-outline-*</code> & <code>.badge-pill</code> for border color.</p>
                    <div class="badges-content button-items">
                        <button type="button" class="btn btn-outline-primary">Primary <span class="badge ml-2">1</span></button>
                        <button type="button" class="btn btn-outline-success">Success <span class="badge ml-2">2</span></button>
                        <button type="button" class="btn btn-outline-info">Info <span class="badge ml-2">3</span></button>
                        <button type="button" class="btn btn-outline-warning">warning <span class="badge ml-2">4</span></button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="mt-4 mt-xl-0">
                                <h5 class="font-size-14">Pagination Rounded</h5>
                                <p class="card-title-desc">Pagination links indicate a series of related content exists across multiple pages & add class <code>.pagination-rounded</code>.</p>
