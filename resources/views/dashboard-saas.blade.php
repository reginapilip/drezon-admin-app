                    ...
                    <div class="float-right">
                        <div class="dropdown">
                            <a class="btn-link text-muted dropdown-toggle arrow-none" href="#" role="button"
                                id="dropdownMenuLink-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink-2">
                                ...
                                <a class="dropdown-item" href="#"><i class="icon-xs icon mr-2" data-feather="edit"></i>
                                    Edit</a>
                                <a class="dropdown-item" href="#"><i class="icon-xs icon mr-2" data-feather="activity"></i>
                                    Action</a>
                        ...
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="media align-items-center">
                                            <img src="{{ URL::asset('/assets/images/product/product-x/pro-1.png') }}" alt=""
                                                class="imf-fluid avatar mr-3" />
                                            <div class="media-body">
                                    ...
                                    <td><span
                                            class="py-1 px-2 bg-soft-primary text-primary font-weight-medium font-size-13 rounded">Headphone</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="media align-items-center">
                                            <img src="{{ URL::asset('/assets/images/product/product-x/pro-2.png') }}" alt=""
                                                class="imf-fluid avatar mr-3" />
                                            <div class="media-body">
                                    ...
                                    <td><span
                                            class="py-1 px-2 bg-soft-primary text-primary font-weight-medium font-size-13 rounded">Apple
                                            watch</span></td>
                                    <td>
                                        <div class="progress" style="height: 6px;">
                                ...
                                <tr>
                                    <td>
                                        <div class="media align-items-center">
                                            <img src="{{ URL::asset('/assets/images/product/product-x/pro-3.png') }}" alt=""
                                                class="imf-fluid avatar mr-3" />
                                            <div class="media-body">
                                    ...
                                    <td>David Murphy</td>
                                    <td><span
                                            class="py-1 px-2 bg-soft-primary text-primary font-weight-medium font-size-13 rounded">T-shirt</span>
                                    </td>
                                    <td>
                                        <div class="progress" style="height: 6px;">
                                ...
                                <tr>
                                    <td>
                                        <div class="media align-items-center">
                                            <img src="{{ URL::asset('/assets/images/product/product-x/pro-4.png') }}" alt=""
                                                class="imf-fluid avatar mr-3" />
                                            <div class="media-body">
                                    ...
                                    <td>Richard Smith</td>
                                    <td><span
                                            class="py-1 px-2 bg-soft-primary text-primary font-weight-medium font-size-13 rounded">iPhone
                                            7s</span></td>
                                    <td>
                                        <div class="progress" style="height: 6px;">
                        ...
                        <div class="col-md-7">
                            <ul class="list-inline text-md-right mb-4 pb-2">
                                <li class="list-inline-item mr-3"><i
                                        class="mdi mdi-circle font-size-14 text-success mr-2"></i>Completed</li>
                                <li class="list-inline-item"><i
                                        class="mdi mdi-circle font-size-14 text-danger mr-2"></i>Incompleted</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="card bg-light rounded shadow-none">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">
                                        Completed <span class="text-success ml-2"><i class="icon-xs icon mr-2"
                                                data-feather="trending-up"></i>8.5%</span>
                                    </p>
                        ...
                        <div class="col-md-6">
                            <div class="card bg-light rounded shadow-none">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">
                                        Incompleted <span class="text-danger ml-2"><i class="icon-xs icon mr-2"
                                                data-feather="trending-down"></i>3.2%</span>
                                    </p>
                                    <p class="text-muted mb-0">Quis autem a eum iure reprehenderit voluptate velit
                                        consequatur.</p>
                                </div>
                            </div>
                        </div>
