                        ...
                        <div class="col-md-6">
                            <div class="mt-4 mt-md-0">
                                <img class="rounded-circle avatar-xl" alt="200x200"
                                    src="{{ URL::asset('/assets/images/users/avatar-4.jpg') }}" data-holder-rendered="true">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media mb-4">
                        <img class="avatar-sm mr-3 rounded-circle"
                            src="{{ URL::asset('/assets/images/users/avatar-6.jpg') }}" alt="">
                    ...
                    <div class="media">
                        ...
                        <img class="avatar-sm ml-3 rounded-circle"
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media mb-4">
                        <img class="avatar-sm align-self-start rounded mr-3"
                            src="{{ URL::asset('/assets/images/users/avatar-3.jpg') }}" alt="">
                        <div class="media-body">
                            <h5 class="mt-0 font-size-14">Top-aligned media</h5>
                            <p class="mb-2">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                                sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce
                    ...
                    <div class="media mb-4">
                        <img class="avatar-sm align-self-center rounded mr-3"
                    ...
                    <div class="media">
                        <img class="avatar-sm align-self-end rounded mr-3"
