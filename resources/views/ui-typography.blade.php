...
@section('content')
        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="mb-3">h6. Bootstrap heading <small class="text-muted">Semibold 0.9rem (14.4px)</small></h6>
                </div>
            </div>
        </div>
        <div class="col-xl-6">
    ...
    <div class="row">
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Blockquotes Primary</h4>
                    <p class="card-title-desc mb-4">Add <code>.custom-blockpuote</code> & <code>.blockpuote-*</code> for
                    ...
                    <blockquote class="blockquote custom-blockpuote blockpuote-primary rounded mb-0">
                        ...
                        <footer class="blockquote-footer font-size-13"> Angie Burt <cite
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Blockquotes Success</h4>
                    <p class="card-title-desc mb-4">Add <code>.custom-blockpuote</code> & <code>.blockpuote-*</code> for
                        background & border color.
                    </p>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Blockquotes Orange</h4>
                    <p class="card-title-desc mb-4">Add <code>.custom-blockpuote</code> & <code>.blockpuote-*</code> for
                        background & border color.
                    </p>
                    <blockquote class="blockquote custom-blockpuote blockpuote-orange rounded mb-0">
                        <p class="font-size-14 text-dark mb-2">At vero eos et accusamus dignissimos ducimus blanditiis.</p>
                        <footer class="blockquote-footer font-size-13"> Angie Burt <cite
                                title="Source Title">Designer</cite></footer>
                    </blockquote>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Blockquotes Outline Primary</h4>
                    <p class="card-title-desc mb-4">Add <code>.custom-blockpuote</code> & <code>.blockpuote-outline*</code>
                        for background & border color.
                    </p>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Blockquotes Outline Success</h4>
                    <p class="card-title-desc mb-4">Add <code>.custom-blockpuote</code> & <code>.blockpuote-outline*</code>
                        for background & border color.
                    </p>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Blockquotes Outline Orange</h4>
                    <p class="card-title-desc mb-4">Add <code>.custom-blockpuote</code> & <code>.blockpuote-outline*</code>
                        for background & border color.
                    </p>
                    <blockquote class="blockquote custom-blockpuote blockpuote-outline-orange rounded mb-0">
                        <p class="font-size-14 text-dark mb-2">At vero eos et accusamus dignissimos ducimus blanditiis.</p>
                        <footer class="blockquote-footer font-size-13"> Angie Burt <cite
                                title="Source Title">Designer</cite></footer>
                    </blockquote>
