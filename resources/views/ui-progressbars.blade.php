        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Add <code class="highlighter-rounge">.bg-gradient-*</code> class with <code
                            class="highlighter-rounge">.progress-bar</code> for gradient progressbar.</p>

                    <div class="">
                        <div class="progress mb-4">
                            <div class="progress-bar bg-gradient-primary" role="progressbar" style="width: 25%"
                                aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="progress mb-4">
                            <div class="progress-bar bg-gradient-success" role="progressbar" style="width: 50%"
                                aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="progress mb-4">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="">
                        <div class="progress custom-progress-bar mb-4" style="height: 8px;">
                        ...
                        <div class="progress custom-progress-bar" style="height: 8px;">
                            <div class="progress-bar bg-danger" role="progressbar" style="width: 100%" aria-valuenow="100"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
