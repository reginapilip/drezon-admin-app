                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="colorpicker-default form-control" value="#34c38f">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group colorpicker-default" title="Using format option">
                                        <input type="text" class="form-control input-lg" value="#5b73e8" />
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" data-provide="datepicker"
                                        data-date-format="dd M, yyyy" data-date-min-view-mode="1">
                                </div>
