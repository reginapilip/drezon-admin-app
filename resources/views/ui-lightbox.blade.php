            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="zoom-gallery">
                        <a class="float-left" href="{{ URL::asset('/assets/images/small/img-3.jpg') }}" title="Project 1"><img
                                src="{{ URL::asset('/assets/images/small/img-3.jpg') }}" alt="" width="275"></a>
                        <a class="float-left" href="{{ URL::asset('/assets/images/small/img-7.jpg') }}" title="Project 2"><img
