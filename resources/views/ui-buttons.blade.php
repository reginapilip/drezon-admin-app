...
@section('content')
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Replace the default modifier classes with the <code
                            class="highlighter-rouge">.btn-outline-*</code> & <code
                            class="highlighter-rouge">.btn-rounded</code> ones to remove all background images and colors on
                        any button.</p>
                    <div class="button-items">
                        <button type="button"
                            class="btn btn-outline-primary btn-rounded waves-effect waves-light">Primary</button>
                        ...
                        <button type="button"
                            class="btn btn-outline-info btn-rounded waves-effect waves-light">Info</button>
                        <button type="button"
                            class="btn btn-outline-warning btn-rounded waves-effect waves-light">Warning</button>
                        <button type="button"
                            class="btn btn-outline-danger btn-rounded waves-effect waves-light">Danger</button>
                        <button type="button"
                            class="btn btn-outline-dark btn-rounded waves-effect waves-light">Dark</button>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Soft background rounded buttons</h4>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Add <code>.btn-soft-*</code> class with <code>.btn-*</code> &
                        <code>.btn-rounded</code> color button for a Soft background & rounded buttons.
                    </p>
                    <div class="button-items">
                        <button type="button"
                            class="btn btn-primary btn-soft-primary btn-rounded waves-effect waves-light">Primary</button>
                        <button type="button"
                            class="btn btn-success btn-soft-success btn-rounded waves-effect waves-light">Success</button>
                        <button type="button"
                            class="btn btn-info btn-soft-info btn-rounded waves-effect waves-light">Info</button>
                        <button type="button"
                            class="btn btn-warning btn-soft-warning btn-rounded waves-effect waves-light">Warning</button>
                        <button type="button"
                            class="btn btn-danger btn-soft-danger btn-rounded waves-effect waves-light">Danger</button>
                        <button type="button"
                            class="btn btn-dark btn-soft-dark btn-rounded waves-effect waves-light">Dark</button>
                        <button type="button"
                            class="btn btn-secondary btn-soft-secondary btn-rounded waves-effect waves-light">Secondary</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Icon in button.</p>
                    ...
                    <div class="button-items mt-4">
                        ...
                        <button type="button" class="btn btn-outline-purple waves-effect waves-light">
                            <i class="uil uil-bag-alt"></i>
                        </button>
                    ...
                    <div class="button-items mt-4">
                        ...
                        <button type="button" class="btn btn-soft-purple waves-effect waves-light">
                            <i class="uil uil-bag-alt"></i>
                        </button>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-items">
                        <button type="button" class="btn btn-primary waves-effect waves-light">
                            Primary <i class="uil uil-user ml-2"></i>
                        </button>
                        <button type="button" class="btn btn-success waves-effect waves-light">
                            <i class="uil uil-check mr-2"></i> Success
                        </button>
                        <button type="button" class="btn btn-warning waves-effect waves-light">
                            <i class="uil uil-exclamation-triangle mr-2"></i> Warning
                        </button>
                        <button type="button" class="btn btn-info waves-effect waves-light">
                            <i class="uil uil-info-circle mr-2"></i> Info
                        </button>
                        <button type="button" class="btn btn-danger waves-effect waves-light">
                            <i class="uil uil-exclamation-octagon mr-2"></i> Danger
                        </button>
                    </div>
