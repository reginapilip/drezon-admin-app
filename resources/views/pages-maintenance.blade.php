                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-sm-5">
                                <div class="maintenance-img">
                                    <img src="{{ URL::asset('/assets/images/maintenance.gif') }}" alt=""
                            ...
                            <div class="col-md-4">
                                <div class="card mt-4 maintenance-box">
                                    <div class="card-body p-4">
                                        <div class="avatar mx-auto p-1 border border-soft-primary rounded mb-4">
                                            <div class="avatar-title rounded bg-soft-primary text-primary font-size-20">
                                                <i class="icon-sm" data-feather="server"></i>
                                            </div>
                                        </div>
