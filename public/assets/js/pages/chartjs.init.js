  ...
  ChartJs.prototype.init = function () {
    ...
    var lineChart = {
      ...
      datasets: [{
        ...
        pointBorderColor: "#2a4fd7",
        pointBackgroundColor: "#fff",
        pointBorderWidth: 1,
        pointHoverRadius: 5,
        pointHoverBackgroundColor: "#2a4fd7",
    ...
    var donutChart = {
      ...
      datasets: [{
        data: [300, 210],
        backgroundColor: ["#2a4fd7", "#ebeff2"],
        hoverBackgroundColor: ["#2a4fd7", "#ebeff2"],
    ...
    var radarChart = {
      ...
      datasets: [{
        ...
        borderColor: "#fa7f56",
        pointBackgroundColor: "#fa7f56",
        pointBorderColor: "#fff",
        pointHoverBackgroundColor: "#fff",
        pointHoverBorderColor: "#fa7f56",
        data: [65, 59, 90, 81, 56, 55, 40]
      }, {
        label: "Tablets",
        backgroundColor: "rgba(91, 140, 232, 0.2)",
        borderColor: "#2a4fd7",
        pointBackgroundColor: "#2a4fd7",
        pointBorderColor: "#fff",
        pointHoverBackgroundColor: "#fff",
        pointHoverBorderColor: "#2a4fd7",
    ...
    var polarChart = {
      datasets: [{
        data: [11, 16, 7, 18],
        backgroundColor: ["#35d1df", "#34c38f", "#e4a73e", "#2a4fd7"],
        label: 'My dataset',
        // for legend
        hoverBorderColor: "#fff"
      }],
...
module.exports = __webpack_require__(/*! C:\Users\regin\code\snap-project\resources\js\pages\chartjs.init.js */"./resources/js/pages/chartjs.init.js");
